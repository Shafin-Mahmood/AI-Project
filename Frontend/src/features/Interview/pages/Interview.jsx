  ...
  return (
    <div className="q-card">
      <div className="q-card__header" onClick={() => setOpen(!open)}>
        ...
        <p className="q-card__question">{item?.question || "No question found"}</p>
  ...
  return (
    <div className="roadmap-day">
      <div className="roadmap-day__header">
        ...
        <h3 className="roadmap-day__focus">{day?.focus || "No focus found"}</h3>
      </div>
    ...
    <div className="interview-page">
      <div className="interview-layout">
        ...
        <nav className="interview-nav">
          ...
          <button onClick={handleDownloadResume} className="button primary-button">
            Download Resume
          </button>
        </nav>
